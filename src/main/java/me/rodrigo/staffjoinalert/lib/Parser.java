...
public class Parser {
    ...
    public Parser(final Path Path) throws FileNotFoundException {
        ...
        this.AllData = Parser.load(new FileInputStream(Path.toString()));
    }
    ...
    public ArrayList AsArrayList(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public ArrayList<String> AsStringList(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public ArrayList<Integer> AsIntegerList(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public ArrayList<Double> AsDoubleList(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public ArrayList<Long> AsLongList(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public int AsInt(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public long AsLong(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
    ...
    public double AsDouble(final String Path) {
        try {
            final String[] Parts = Path.split("\\.");
